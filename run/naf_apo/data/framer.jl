...
nc_file  = string("/home/german/labo/16/lbp/run/naf_apo/data/naf_apo_90000.nc")
folder_frames  = string("/home/german/labo/16/lbp/run/naf_apo/data/frames")
prmtop_file = string("/home/german/labo/16/lbp/top_files/dry_naf_apo.prmtop")

for i=0:10:90000
    if i == 0
        i = 1
    end
    cpptraj_in_file = string("/home/german/labo/16/lbp/run/naf_apo/data/", i,"_framer_in_cpp")
    pdb_file  = string("/home/german/labo/16/lbp/run/naf_apo/data/", i,"frame_naf_apo.pdb")
