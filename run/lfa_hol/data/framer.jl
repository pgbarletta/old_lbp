...
nc_file  = string("/home/german/labo/16/lbp/run/lfa_hol/data/lfa_hol_90000.nc")
folder_frames  = string("/home/german/labo/16/lbp/run/lfa_hol/data/frames")
prmtop_file = string("/home/german/labo/16/lbp/top_files/dry_lfa_hol.prmtop")

for i=0:10:90000
    if i == 0
        i = 1
    end
    cpptraj_in_file = string("/home/german/labo/16/lbp/run/lfa_hol/data/", i,"_framer_in_cpp")
    pdb_file  = string("/home/german/labo/16/lbp/run/lfa_hol/data/", i,"frame_lfa_hol.pdb")
